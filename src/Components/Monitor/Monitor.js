...
define(['react', 'react-dom', 'components/Profile/Profile'], function (React, ReactDOM, Profile) {
  var Monitor = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Monitor, [{
        ...
        xhr.onreadystatechange = function () {
          if (xhr.readyState === XMLHttpRequest.DONE) {
            ...
            if (status === 0 || status >= 200 && status < 400) {
              var defaultQuestions = JSON.parse(xhr.responseText);
      ...
      value: function render() {
        var defaultQuestions = this.state.defaultQuestions;
